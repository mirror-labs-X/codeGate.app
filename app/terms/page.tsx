        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-zinc-300 text-sm leading-relaxed font-light">
            ...
            <section className="space-y-3">
              ...
              <p>
                THE CODEGATE SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND, EITHER 
                EXPRESSED OR IMPLIED. IN NO EVENT SHALL CODEGATE BE LIABLE FOR ANY CONSEQUENTIAL, 
                INDIRECT, SPECIAL, OR INCIDENTAL DAMAGES ARISING OUT OF THE USE OR INABILITY TO 
                USE THE SOFTWARE, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGE.
              </p>
            </section>
